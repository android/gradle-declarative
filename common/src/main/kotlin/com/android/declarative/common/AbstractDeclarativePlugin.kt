...
/**
 * Common behaviors for the declarative plugins, the [Settings] plugin and the [Project] plugin.
 */
abstract class AbstractDeclarativePlugin {
    ...
    open fun parseDeclarativeInFolder(folder: File, issueLogger: IssueLogger): TomlParseResult =
