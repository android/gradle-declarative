...
import com.android.declarative.common.DeclarativeFileValueSource
import com.android.declarative.common.GradleIssuesWorkarounds
import com.android.declarative.common.JdkLoggerWrapper
import com.android.declarative.common.cache.IncludedBuildPluginCache
...
class SettingsDeclarativePlugin @Inject constructor(
    ...
    override fun apply(settings: Settings) {
        ...
        println("Settings declarative plugin applied in ClassLoader : \n${this.javaClass.classLoader.name}")
    ...
    private fun configureSubProject(
        ...
        if (projectDeclarativeFile.isPresent) {
            ...
            project.apply(mapOf("plugin" to "com.android.experiments.declarative.project"))
        } else {
    ...
    private fun configureRootProject(
        ...
        project.buildscript.dependencies.also { dependencyHandler ->
            ...
            dependencyHandler.add(
                ScriptHandler.CLASSPATH_CONFIGURATION,
                "com.android.experiments.declarative:project-api:${Constants.PLUGIN_VERSION}"
            )
        }
