...
class DependencyProcessor(
    private val plugin: AbstractDeclarativePlugin,
...
//            }
    ...
    private fun addExtensionDependency(
        plugin: AbstractDeclarativePlugin,
        dependency: DependencyInfo.ExtensionFunction
    ) {
        if (dependency.extension == "kotlin") {
            ...
            val kotlinDependencyExtensions = plugin.javaClass.classLoader.loadClass(
